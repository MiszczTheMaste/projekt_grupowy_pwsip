...
use App\Auth\CommandHandler\PasswordChangeHandler;
...
class PasswordChangeAction extends AbstractController
{
    ...
    public function __construct(PasswordChangeHandler $handler, UserRepository $userRepository, UserPasswordHasherInterface $passwordEncoder, EntityManagerInterface $entityManager)
    {
